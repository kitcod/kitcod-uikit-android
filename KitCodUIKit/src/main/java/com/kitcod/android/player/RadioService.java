...
public class RadioService extends Service implements Player.EventListener, AudioManager.OnAudioFocusChangeListener {
    ...
    public void onCreate() {
        ...
        strAppName = getResources().getString(R.string.hello_blank_fragment);
        strLiveBroadcast = getResources().getString(R.string.hello_blank_fragment);
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
        ...
        if (!status.equals(PlaybackStatus.IDLE))
            notificationManager.startNotify(status, streamUrl);

//        EventBus.getDefault().post(status);
        ExoplayerModel exoplayerModel = new ExoplayerModel();
        exoplayerModel.setStatus(status);
        exoplayerModel.setExoPlayer(exoPlayer);
        EventBus.getDefault().post(exoplayerModel);
    }
